...
class Quote(val boardID: String,
            val date: String,
    ...
    companion object {
        fun parseJson(listOfParams: List<String>): Quote {
            return Quote(listOfParams[0],
                    listOfParams[1],
                    listOfParams[2],
                    listOfParams[3],
